window.onload = () ->
	...
	window.camera = new THREE.PerspectiveCamera( 45, window.innerWidth / (window.innerHeight-window.menu.clientHeight+10), 0.25, 20 )
	...
	window.renderer.setSize( window.innerWidth, window.innerHeight-window.menu.clientHeight+10 )
...
window.animate = () ->
	...
	window.point_light.position.y = window.mouse.y
	window.point_light.position.x = window.mouse.x
